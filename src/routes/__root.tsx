...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SOARES BBR — Official" },
      { name: "description", content: "Soares BBR — TikTok, YouTube e Discord. Entre no submundo." },
      { name: "author", content: "Soares BBR" },
      { property: "og:title", content: "SOARES BBR — Official" },
